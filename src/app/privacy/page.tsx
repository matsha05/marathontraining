    ...
    return (
        <main className="min-h-screen landing-shell px-6 py-16">
            <article className="max-w-3xl mx-auto">
                ...
                {/* Data Controller */}
                <section className="mb-10">
                    <h2 className="text-display-sm mb-4">1. Data Controller</h2>
                    <p className="text-body-md text-[var(--text-secondary)] mb-4">
                        For the purposes of the GDPR, the data controller is:
                    </p>
                    <div className="p-4 rounded-lg bg-[var(--bg-elevated)] border border-[var(--border-base)]">
                        <p className="text-body-md">The Long Game</p>
                        <p className="text-body-sm text-[var(--text-muted)]">
                            Contact: <a href="mailto:privacy@thelonggame.app" className="text-[var(--color-accent)]">privacy@thelonggame.app</a>
                        </p>
                    </div>
                </section>
                ...
                {/* What We Collect */}
                <section className="mb-10">
                    <h2 className="text-display-sm mb-4">2. Information We Collect</h2>

                    <div className="space-y-6">
                        <div>
                            <h3 className="text-label mb-2">Account Information</h3>
                            <ul className="list-disc list-inside text-body-md text-[var(--text-secondary)] space-y-1">
                        ...
                        <div>
                            <h3 className="text-label mb-2">Training &amp; Health Data</h3>
                            <ul className="list-disc list-inside text-body-md text-[var(--text-secondary)] space-y-1">
                        ...
                        <div>
                            <h3 className="text-label mb-2">Connected Services (Optional)</h3>
                        ...
                        <div>
                            <h3 className="text-label mb-2">Technical Data</h3>
                            <ul className="list-disc list-inside text-body-md text-[var(--text-secondary)] space-y-1">
                ...
                {/* Legal Basis (GDPR) */}
                <section className="mb-10">
                    <h2 className="text-display-sm mb-4">3. Legal Basis for Processing (GDPR)</h2>
                    <p className="text-body-md text-[var(--text-secondary)] mb-4">
                        We process your personal data under the following legal bases:
                    </p>

                    <div className="overflow-x-auto">
                        <table className="w-full text-body-sm border border-[var(--border-base)] rounded-lg overflow-hidden">
                            <thead className="bg-[var(--bg-elevated)]">
                                <tr>
                                    <th className="text-left p-3 border-b border-[var(--border-base)]">Purpose</th>
                                    <th className="text-left p-3 border-b border-[var(--border-base)]">Legal Basis</th>
                                </tr>
                            </thead>
                            <tbody className="text-[var(--text-secondary)]">
                                <tr>
                                    <td className="p-3 border-b border-[var(--border-base)]">Account creation &amp; authentication</td>
                                    <td className="p-3 border-b border-[var(--border-base)]">Contract performance</td>
                                </tr>
                                <tr>
                                    <td className="p-3 border-b border-[var(--border-base)]">Training plan generation</td>
                                    <td className="p-3 border-b border-[var(--border-base)]">Contract performance</td>
                                </tr>
                                <tr>
                                    <td className="p-3 border-b border-[var(--border-base)]">Health &amp; fitness data processing</td>
                                    <td className="p-3 border-b border-[var(--border-base)]">Explicit consent</td>
                                </tr>
                                <tr>
                                    <td className="p-3 border-b border-[var(--border-base)]">Service improvement &amp; analytics</td>
                                    <td className="p-3 border-b border-[var(--border-base)]">Legitimate interest</td>
                                </tr>
                                <tr>
                ...
                {/* How We Use Data */}
                <section className="mb-10">
                    <h2 className="text-display-sm mb-4">4. How We Use Your Information</h2>
                    <ul className="list-disc list-inside text-body-md text-[var(--text-secondary)] space-y-2">
                ...
                {/* Data Retention */}
                <section className="mb-10">
                    <h2 className="text-display-sm mb-4">5. Data Retention</h2>
                    <ul className="list-disc list-inside text-body-md text-[var(--text-secondary)] space-y-2">
                ...
                {/* Data Sharing */}
                <section className="mb-10">
                    <h2 className="text-display-sm mb-4">6. Data Sharing &amp; Third Parties</h2>
                    <p className="text-body-md text-[var(--text-secondary)] mb-4">
                        We do not sell your personal data. We share data only with:
                    </p>
                    <div className="space-y-4">
                        <div className="p-4 rounded-lg bg-[var(--bg-elevated)] border border-[var(--border-base)]">
                            <p className="text-label mb-1">Supabase (Database &amp; Auth)</p>
                            <p className="text-body-sm text-[var(--text-muted)]">Account data, training data · US-based · SOC 2 Type II certified</p>
                        </div>
                        <div className="p-4 rounded-lg bg-[var(--bg-elevated)] border border-[var(--border-base)]">
                            <p className="text-label mb-1">Vercel (Hosting)</p>
                            <p className="text-body-sm text-[var(--text-muted)]">Application hosting · US/EU edge locations · SOC 2 certified</p>
                        </div>
                        <div className="p-4 rounded-lg bg-[var(--bg-elevated)] border border-[var(--border-base)]">
                            <p className="text-label mb-1">Garmin &amp; Strava APIs</p>
                            <p className="text-body-sm text-[var(--text-muted)]">Only when you connect · Read-only access · Disconnectable anytime</p>
                        </div>
                    </div>
                </section>
                ...
                <section className="mb-10">
                    <h2 className="text-display-sm mb-4">7. International Data Transfers</h2>
                ...
                {/* Your Rights */}
                <section className="mb-10">
                    <h2 className="text-display-sm mb-4">8. Your Rights</h2>
                    <p className="text-body-md text-[var(--text-secondary)] mb-4">
                    ...
                    <p className="text-body-sm text-[var(--text-muted)] mt-4">
                        To exercise these rights, email <a href="mailto:privacy@thelonggame.app" className="text-[var(--color-accent)]">privacy@thelonggame.app</a>.
                ...
                {/* CCPA */}
                <section className="mb-10">
                    <h2 className="text-display-sm mb-4">9. California Privacy Rights (CCPA)</h2>
                    <p className="text-body-md text-[var(--text-secondary)]">
                ...
                {/* Cookies */}
                <section className="mb-10">
                    <h2 className="text-display-sm mb-4">10. Cookies &amp; Tracking</h2>
                    <p className="text-body-md text-[var(--text-secondary)]">
                ...
                {/* Security */}
                <section className="mb-10">
                    <h2 className="text-display-sm mb-4">11. Data Security</h2>
                    <ul className="list-disc list-inside text-body-md text-[var(--text-secondary)] space-y-2">
                ...
                {/* Children */}
                <section className="mb-10">
                    <h2 className="text-display-sm mb-4">12. Children&apos;s Privacy</h2>
                    <p className="text-body-md text-[var(--text-secondary)]">
                ...
                {/* Changes */}
                <section className="mb-10">
                    <h2 className="text-display-sm mb-4">13. Changes to This Policy</h2>
                    <p className="text-body-md text-[var(--text-secondary)]">
                ...
                {/* Contact & Complaints */}
                <section className="mb-10">
                    <h2 className="text-display-sm mb-4">14. Contact &amp; Complaints</h2>
                    <p className="text-body-md text-[var(--text-secondary)] mb-4">
                        For privacy-related questions or to exercise your rights:
                    </p>
                    <div className="p-4 rounded-lg bg-[var(--bg-elevated)] border border-[var(--border-base)]">
                        <p className="text-body-md mb-2">
                            Email: <a href="mailto:privacy@thelonggame.app" className="text-[var(--color-accent)]">privacy@thelonggame.app</a>
                        </p>
                    </div>
                    <p className="text-body-sm text-[var(--text-muted)] mt-4">
