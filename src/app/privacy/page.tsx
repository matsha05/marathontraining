    ...
    return (
        <div className="v3-root min-h-screen">
            ...
            <main className="px-6 pt-12 pb-16">
                <article className="v3-container-narrow mx-auto">
                    {/* Back Button */}
                    <Link
                        href="/"
                    ...
                    <header className="mb-12">
                        <h1 className="v3-heading-lg mb-4">Privacy Policy</h1>
                    ...
                    <section className="mb-10">
                        <p className="v3-body" style={{ color: 'var(--text-muted)', lineHeight: '1.7' }}>
                    ...
                    {/* Data Controller */}
                    <section className="mb-10">
                        <h2 className="v3-heading-md mb-4">1. Data Controller</h2>
                        <p className="v3-body mb-4" style={{ color: 'var(--text-muted)' }}>
                    ...
                    {/* What We Collect */}
                    <section className="mb-10">
                        <h2 className="v3-heading-md mb-4">2. Information We Collect</h2>

                        <div className="space-y-6">
                            <div>
                                <h3 className="v3-label mb-2">Account Information</h3>
                                <ul className="v3-body space-y-1" style={{ color: 'var(--text-muted)', listStyleType: 'disc', paddingLeft: '1.5rem' }}>
                            ...
                            <div>
                                <h3 className="v3-label mb-2">Training &amp; Health Data</h3>
                                <ul className="v3-body space-y-1" style={{ color: 'var(--text-muted)', listStyleType: 'disc', paddingLeft: '1.5rem' }}>
                            ...
                            <div>
                                <h3 className="v3-label mb-2">Connected Services (Optional)</h3>
                                <p className="v3-body mb-2" style={{ color: 'var(--text-muted)' }}>
                            ...
                            <div>
                                <h3 className="v3-label mb-2">Technical Data</h3>
                                <ul className="v3-body space-y-1" style={{ color: 'var(--text-muted)', listStyleType: 'disc', paddingLeft: '1.5rem' }}>
                    ...
                    {/* Legal Basis (GDPR) */}
                    <section className="mb-10">
                        <h2 className="v3-heading-md mb-4">3. Legal Basis for Processing (GDPR)</h2>
                        <p className="v3-body mb-4" style={{ color: 'var(--text-muted)' }}>
                    ...
                    {/* How We Use Data */}
                    <section className="mb-10">
                        <h2 className="v3-heading-md mb-4">4. How We Use Your Information</h2>
                        <ul className="v3-body space-y-2" style={{ color: 'var(--text-muted)', listStyleType: 'disc', paddingLeft: '1.5rem' }}>
                    ...
                    {/* Data Retention */}
                    <section className="mb-10">
                        <h2 className="v3-heading-md mb-4">5. Data Retention</h2>
                        <ul className="v3-body space-y-2" style={{ color: 'var(--text-muted)', listStyleType: 'disc', paddingLeft: '1.5rem' }}>
                    ...
                    {/* Data Sharing */}
                    <section className="mb-10">
                        <h2 className="v3-heading-md mb-4">6. Data Sharing &amp; Third Parties</h2>
                        <p className="v3-body mb-4" style={{ color: 'var(--text-muted)' }}>
                            We do not sell your personal data. We share data only with:
                        </p>
                        <div className="space-y-3">
                            <div className="v3-card">
                                <p className="v3-label mb-1">Supabase (Database &amp; Auth)</p>
                                <p className="v3-body-sm" style={{ color: 'var(--text-muted)' }}>Account data, training data · US-based · SOC 2 Type II certified</p>
                            </div>
                            <div className="v3-card">
                                <p className="v3-label mb-1">Vercel (Hosting)</p>
                                <p className="v3-body-sm" style={{ color: 'var(--text-muted)' }}>Application hosting · US/EU edge locations · SOC 2 certified</p>
                            </div>
                            <div className="v3-card">
                                <p className="v3-label mb-1">Garmin &amp; Strava APIs</p>
                                <p className="v3-body-sm" style={{ color: 'var(--text-muted)' }}>Only when you connect · Read-only access · Disconnectable anytime</p>
                            </div>
                        </div>
                    </section>
                    ...
                    <section className="mb-10">
                        <h2 className="v3-heading-md mb-4">7. International Data Transfers</h2>
                    ...
                    {/* Your Rights */}
                    <section className="mb-10">
                        <h2 className="v3-heading-md mb-4">8. Your Rights</h2>
                        <p className="v3-body mb-4" style={{ color: 'var(--text-muted)' }}>
                    ...
                    {/* CCPA */}
                    <section className="mb-10">
                        <h2 className="v3-heading-md mb-4">9. California Privacy Rights (CCPA)</h2>
                        <p className="v3-body" style={{ color: 'var(--text-muted)' }}>
                    ...
                    {/* Cookies */}
                    <section className="mb-10">
                        <h2 className="v3-heading-md mb-4">10. Cookies &amp; Tracking</h2>
                        <p className="v3-body" style={{ color: 'var(--text-muted)' }}>
                    ...
                    {/* Security */}
                    <section className="mb-10">
                        <h2 className="v3-heading-md mb-4">11. Data Security</h2>
                        <ul className="v3-body space-y-2" style={{ color: 'var(--text-muted)', listStyleType: 'disc', paddingLeft: '1.5rem' }}>
                    ...
                    {/* Children */}
                    <section className="mb-10">
                        <h2 className="v3-heading-md mb-4">12. Children&apos;s Privacy</h2>
                        <p className="v3-body" style={{ color: 'var(--text-muted)' }}>
                    ...
                    {/* Changes */}
                    <section className="mb-10">
                        <h2 className="v3-heading-md mb-4">13. Changes to This Policy</h2>
                        <p className="v3-body" style={{ color: 'var(--text-muted)' }}>
                    ...
                    {/* Contact & Complaints */}
                    <section className="mb-10">
                        <h2 className="v3-heading-md mb-4">14. Contact &amp; Complaints</h2>
                        <p className="v3-body mb-4" style={{ color: 'var(--text-muted)' }}>
