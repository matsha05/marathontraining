        ...
        <main className="v2-root min-h-screen px-6 py-16">
            <article className="v2-container-narrow mx-auto">
                ...
                <section className="mb-10">
                    <p className="v2-body" style={{ color: 'var(--v2-text-tertiary)', lineHeight: '1.7' }}>
                ...
                <section className="mb-10">
                    ...
                    <p className="v2-body mb-4" style={{ color: 'var(--v2-text-secondary)' }}>
                ...
                <section className="mb-10">
                    ...
                    <div className="space-y-6">
                        <div>
                            ...
                            <ul className="v2-body space-y-1" style={{ color: 'var(--v2-text-secondary)', listStyleType: 'disc', paddingLeft: '1.5rem' }}>
                        ...
                        <div>
                            ...
                            <p className="v2-body mb-2" style={{ color: 'var(--v2-text-secondary)' }}>
                ...
                <section className="mb-10">
                    ...
                    <ul className="v2-body space-y-2" style={{ color: 'var(--v2-text-secondary)', listStyleType: 'disc', paddingLeft: '1.5rem' }}>
                ...
                <section className="mb-10">
                    ...
                    <div className="space-y-3">
                        <div className="v2-card">
                            ...
                            <p className="v2-body-sm" style={{ color: 'var(--v2-text-muted)' }}>Account data, training data · US-based · SOC 2 Type II certified</p>
                        </div>
                        <div className="v2-card">
                            <p className="v2-label mb-1">Vercel (Hosting)</p>
                            <p className="v2-body-sm" style={{ color: 'var(--v2-text-muted)' }}>Application hosting · US/EU edge locations · SOC 2 certified</p>
                        </div>
                        <div className="v2-card">
                            <p className="v2-label mb-1">Garmin &amp; Strava APIs</p>
                            <p className="v2-body-sm" style={{ color: 'var(--v2-text-muted)' }}>Only when you connect · Read-only access · Disconnectable anytime</p>
                        </div>
                    </div>
                </section>
                ...
                <section className="mb-10">
                    ...
                    <p className="v2-body" style={{ color: 'var(--v2-text-secondary)' }}>
