...
/**
 * THE LONG GAME - Landing Page V2
 * 
 * Week aesthetic: Dark, atmospheric, light typography.
 * Full coaching philosophy showcase.
 */
    ...
    <div className="min-h-screen bg-[#08080a] text-white">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 px-6 py-5">
        <div className="max-w-5xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            <Link href="/methodology" className="text-xs text-white/40 hover:text-white/60 transition-colors">
              Methodology
            </Link>
            <Link href="/philosophy" className="text-xs text-white/40 hover:text-white/60 transition-colors">
              Find Your Coach
            </Link>
            <Link href="/auth" className="text-xs text-white hover:text-white/80 transition-colors">
              Get Started →
            </Link>
          </div>
        </div>
      ...
      <footer className="px-6 py-6 border-t border-white/5">
        <div className="max-w-5xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            <Link href="/privacy" className="text-[10px] text-white/15 hover:text-white/30 transition-colors">Privacy</Link>
            <Link href="/terms" className="text-[10px] text-white/15 hover:text-white/30 transition-colors">Terms</Link>
          </div>
        </div>
      </footer>
    </div>
