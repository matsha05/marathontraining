        ...
        <div className="v3-root min-h-screen">
            ...
            <main className="px-6 pt-12 pb-16">
                <article className="v3-container-narrow mx-auto">
                    ...
                    <h1 className="v3-heading-lg mb-4">Terms of Service</h1>
                    <p className="v3-body-sm mb-12" style={{ color: 'var(--text-muted)' }}>Last updated: January 3, 2026</p>

                    <section className="mb-10">
                        <h2 className="v3-heading-md mb-4">1. Acceptance of Terms</h2>
                    ...
                    <section className="mb-10">
                        <h2 className="v3-heading-md mb-4">2. Description of Service</h2>
                        <p className="v3-body" style={{ color: 'var(--text-muted)' }}>
                    ...
                    <section className="mb-10">
                        <h2 className="v3-heading-md mb-4">3. User Accounts</h2>
                    ...
                    <section className="mb-10">
                        <h2 className="v3-heading-md mb-4">4. Medical Disclaimer</h2>
                    ...
                    <section className="mb-10">
                        <h2 className="v3-heading-md mb-4">5. Acceptable Use</h2>
                        <p className="v3-body mb-4" style={{ color: 'var(--text-muted)' }}>You agree not to:</p>
                        <ul className="v3-body space-y-2" style={{ color: 'var(--text-muted)', listStyleType: 'disc', paddingLeft: '1.5rem' }}>
                    ...
                    <section className="mb-10">
                        <h2 className="v3-heading-md mb-4">6. Intellectual Property</h2>
                        <p className="v3-body" style={{ color: 'var(--text-muted)' }}>
                    ...
                    <section className="mb-10">
                        <h2 className="v3-heading-md mb-4">7. Third-Party Services</h2>
                        <p className="v3-body" style={{ color: 'var(--text-muted)' }}>
                    ...
                    <section className="mb-10">
                        <h2 className="v3-heading-md mb-4">8. Limitation of Liability</h2>
                        <p className="v3-body" style={{ color: 'var(--text-muted)' }}>
                    ...
                    <section className="mb-10">
                        <h2 className="v3-heading-md mb-4">9. Termination</h2>
                        <p className="v3-body" style={{ color: 'var(--text-muted)' }}>
                    ...
                    <section className="mb-10">
                        <h2 className="v3-heading-md mb-4">10. Changes to Terms</h2>
                        <p className="v3-body" style={{ color: 'var(--text-muted)' }}>
                    ...
                    <section className="mb-10">
                        <h2 className="v3-heading-md mb-4">11. Governing Law</h2>
                        <p className="v3-body" style={{ color: 'var(--text-muted)' }}>
