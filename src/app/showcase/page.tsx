...
const LANDING_OPTIONS: LandingOption[] = [
    {
        id: "week",
        name: "Week",
        description: "The core. Shows what a training week looks like. Full 12-coach methodology on scroll.",
        route: "/landing/week",
        aesthetic: "Calendar • Week View • Complete",
        tags: ["schedule", "methodology", "complete"],
        gradient: "linear-gradient(135deg, #08080a 0%, #0c0c10 100%)",
    },
    {
        id: "week2",
        name: "Week 2",
        description: "Week + explicit race distances. 5K · 10K · Half · Marathon · Ultra listed clearly.",
        route: "/landing/week2",
        aesthetic: "Calendar • Distances • Clean",
        tags: ["distances", "minimal", "explicit"],
        gradient: "linear-gradient(135deg, #08080a 0%, #0a0a10 100%)",
    },
    {
        id: "prime-a",
        name: "Prime A",
        description: "\"The plan behind the finish line\" — outcome-focused, what success looks like.",
        route: "/landing/prime-a",
        aesthetic: "Outcome • Finish Line",
        tags: ["outcome", "success", "finish"],
        gradient: "linear-gradient(135deg, #08080a 0%, #0b0b10 100%)",
    },
    {
        id: "prime-b",
        name: "Prime B",
        description: "\"Training you can trust\" — reliability, science-backed, proven methods.",
        route: "/landing/prime-b",
        aesthetic: "Trust • Science • Proven",
        tags: ["trust", "science", "reliable"],
        gradient: "linear-gradient(135deg, #08080a 0%, #0c0c14 100%)",
    },
    {
        id: "prime-c",
        name: "Prime C",
        description: "\"Every run has a reason\" — intentionality, purpose, no junk miles.",
        route: "/landing/prime-c",
        aesthetic: "Purpose • Intention • Clean",
        tags: ["purpose", "intentional", "reason"],
